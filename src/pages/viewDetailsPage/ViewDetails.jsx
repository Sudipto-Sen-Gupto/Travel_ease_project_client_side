...
const ViewDetails = () => {
  ...
  <div className="max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg p-6 my-10 border border-base-300">
    ...
    <div>
      ...
      {/* Price & Owner */}
      <div className="flex justify-between items-center mt-5 border-b border-base-300 pb-4">
        <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-5 mt-5">
        ...
        <div className="p-3 bg-base-200 rounded-lg">
          <p className="text-base-content/60 text-sm">Transmission</p>
          <p className="font-semibold text-base-content">
        ...
        <div className="p-3 bg-base-200 rounded-lg">
          <p className="text-base-content/60 text-sm">Seats</p>
          <p className="font-semibold text-base-content">
            {vehicle.seats} Seats
          </p>
        </div>
        ...
        <div className="p-3 bg-base-200 rounded-lg">
          <p className="text-base-content/60 text-sm">Availability</p>
          <p
        ...
        <div className="p-3 bg-base-200 rounded-lg">
          <p className="text-base-content/60 text-sm">Vehicle ID</p>
          <p className="font-semibold text-base-content">
            {vehicle.id}
          </p>
        </div>
      ...
      <div className="text-center mt-8">
        <button
          className="btn btn-primary px-10 py-3 text-lg rounded-lg"
          onClick={handleClick}
        >
          🚗 Book Now
        </button>
